...
replacement1 = """       {/* Speaker */}
       <div className="grid grid-cols-[80px_1fr] sm:grid-cols-[100px_1fr] gap-3 sm:gap-5 items-center p-3 sm:p-5 rounded-xl sm:rounded-2xl bg-slate-50 border border-slate-200 mb-4 sm:mb-6">
        ...
        <div className="flex flex-col justify-center">
         ...
         <div className="font-body text-[11px] sm:text-xs text-[#00ADEF] leading-snug">Chuyên gia Phục hồi Thẩm mỹ & Nha khoa Kỹ thuật số</div>
        </div>
       </div>"""
...
replacement2 = """       {/* Speaker */}
       <div className="grid grid-cols-[80px_1fr] sm:grid-cols-[100px_1fr] gap-3 sm:gap-5 items-center p-3 sm:p-5 rounded-xl sm:rounded-2xl bg-slate-50 border border-slate-200 mb-4 sm:mb-6">
        ...
        <div className="flex flex-col justify-center">
         ...
         <div className="font-body text-[11px] sm:text-xs text-[#C43838] leading-snug">Giảng viên & Chuyên gia Vật liệu Nha khoa</div>
        </div>
       </div>"""
